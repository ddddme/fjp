...
+ function($) {
  ...
  $.fn.datetimePicker = function(params) {
    ...
    return this.each(function() {
      ...
      if (params.istime) {
          showCols.push({ divider: true, content: '  ' });
          showCols.push({values: (function () {var arr = [];for (var i = 0; i <= 23; i++) { arr.push(formatNumber(i)); }return arr;})(),});
          showCols.push({ divider: true, content: ':' });
          showCols.push({values: (function () {var arr = [];for (var i = 0; i <= 59; i++) { arr.push(formatNumber(i)); }return arr;})(),});
      }
      var config = {
