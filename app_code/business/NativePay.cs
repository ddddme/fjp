...
namespace FlowRecharge.Wechat
{
    public class NativePay
    {
        ...
        */
        ...
        {
            Log.WriteLog("Native pay mode 1 url is producing...");
            ...
            Log.WriteLog("Get native pay mode 1 url : " + url);
            return url;
        }
        ...
        */
        ...
        {
            Log.WriteLog("Native pay mode 2 url is producing...");
            ...
            Log.WriteLog("Get native pay mode 2 url : " + url);
            return url;
        }
        ...
        */
        ...
        {
            return "";
            //return map.ToArray(x => (Pair<object>)x).Join("&");
        }
    }
}