...
namespace FlowRecharge.Wechat
{
    ...
    public class NativeNotify : Notify
    {
        ...
        {
            var notifyData = this.GetNotifyData();
            ...
            if (!notifyData.IsSet("openid") || !notifyData.IsSet("product_id"))
            {
                ...
                Log.WriteLog("The data WeChat post is error : " + res.ToXml());
            ...
            var unifiedOrderResult = new WxPayData();
            ...
            catch (Exception)//若在调统一下单接口时抛异常，立即返回结果给微信支付后台
            {
                ...
                Log.WriteLog("UnifiedOrder failure : " + res.ToXml());
                page.Response.Write(res.ToXml());
                page.Response.End();
            }
            ...
            Log.WriteLog("UnifiedOrder success , send data to WeChat : " + data.ToXml());
